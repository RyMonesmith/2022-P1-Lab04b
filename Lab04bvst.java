...
public class Lab04bvst extends Applet
{
    ...
    public void paint(Graphics g)
    {
        // DRAW CUBE
        /*
        g.drawRect(100,100,325,325);
        g.drawRect(200,200,325,325);
        g.drawLine(100,100,200,200);
        g.drawLine(425,100,525,200);
        g.drawLine(100,425,200,525);
        g.drawLine(425,425,525,525);
*/
